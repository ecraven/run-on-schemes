...
(define-scheme 'chicken '("csc")
  (lambda (executable input-filename)
    (let-values (((output error status time) (execute-runner (string-append executable " -require-extension r7rs -o /tmp/chicken " input-filename))))
...
(define-scheme 'chicken-csi '("csi")
  #f
  (simple-parameter-runner "-require-extension r7rs -q")
  (make-version-finder "-version" "Version " #\space))
                                              ...
                                              (let* ()
                                                ...
                                                (if sexp?
                                                    (begin
                                                      ...
                                                      (show-item yellow "source-content" #f (read-file input-file))
